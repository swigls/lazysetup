...
rc_append_line "$(lazysetup_root)"/.tmux.conf "setw -g monitor-activity off"
rc_append_line "$(lazysetup_root)"/.tmux.conf "setw -g monitor-bell on"
rc_append_line "$(lazysetup_root)"/.tmux.conf "set -g visual-activity off"
rc_append_line "$(lazysetup_root)"/.tmux.conf "set -g visual-bell on"
